          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="slider-content">
                <div className="sub-title mb-10">Welcome to Chennai Green Gifts</div>
                <h1>Budget Friendly Return Gifts</h1>
                <h6>to make your special event even more memorable.</h6>
                <div className="slider-btns mt-30">
                  <div className="theme-btn style-two" onClick={() => sidebarToggle()}>
                      Order Now <i className="fas fa-angle-double-right" />
                  </div>
                  <Link className="theme-btn style-two" href="#">
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="slider-content">
                <div className="sub-title mb-10">Welcome to Chennai Green Gifts</div>
                <h1>Premium Return Gifts</h1>
                <h6>Fully customized, handcrafted plant-based return gifts to elevate your party.</h6>
                <div className="slider-btns mt-30">
                  <div className="theme-btn style-two" onClick={() => sidebarToggle()}>
                      Order Now <i className="fas fa-angle-double-right" />
                  </div>
